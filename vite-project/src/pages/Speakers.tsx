function Speakers() {
  const speakers = [
    ...
    },
    {
      ...
      desc: "Michael is a public speaker, podcast host, and author. Michael’s talk is about the journey of forgiveness. He speaks about how to both apply and receive forgiveness, as well as the ability to live free through forgiveness, and how that can empower people.\n\n",
    ...
    },
    {
      ...
      desc: "Vita is a visual artist and social media personality focused on the relationship between internet culture, diaspora and public space. They are best known for their video series “Virality as From: The Craziest Thing About Being Creative”. Vita’s talk is about shifting our perspective on virality as a legitimate collaborative art medium.\n\n",
    ...
    },
    {
      ...
      desc: "Nandita is a Senior Product Manager at Cisco and a TEDx speaker focused on AI accessibility and human-centered design who has been featured by Business Insider, NASDAQ, Forbes, and many more. She has been a Board member at various non-profits and actively works in the community to create an inclusive space in communities. Nandita’s talk is about how incorporating accessibility into the way we live benefits us all.\n\n",
