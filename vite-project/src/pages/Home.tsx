  ...
  return (
      ...
      <div className="w-full h-[9061px] relative bg-white overflow-hidden">
        ...
        <div className="w-full h-[644px] px-11 pt-20 left-0 top-[8417px] absolute bg-neutral-200 inline-flex flex-col justify-start items-start gap-14">
            <div className="self-stretch h-52 inline-flex flex-col justify-start items-start">
                <div className="self-stretch self-stretch relative">
                    <img className="w-48 h-12 left-0 top-0 absolute" src="https://placehold.co/186x48" />
                    <div className="w-80 h-7 left-0 top-[66.62px] absolute">
                    <div className="left-0 top-[0.59px] absolute justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-7">Ideas worth spreading</div>
                </div>
            </div>
        <div className="self-stretch self-stretch inline-flex flex-col justify-start items-start gap-5">
            <div className="self-stretch h-7 relative">
                <div className="left-0 top-[-1.19px] absolute justify-start text-stone-800 text-xl font-medium font-['Inter'] leading-7">Navigate</div>
            </div>
            <div className="self-stretch h-40 flex flex-col justify-start items-start gap-3.5">
                <div className="self-stretch h-7 relative">
                    <div className="w-16 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Speakers</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-11 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">About</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-16 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Sponsors</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-20 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Get Tickets</div>
                    </div>
                </div>
            </div>
        </div>
        <div className="self-stretch self-stretch inline-flex flex-col justify-start items-start gap-5">
            <div className="self-stretch h-7 relative">
                <div className="left-0 top-[-1.19px] absolute justify-start text-stone-800 text-xl font-medium font-['Inter'] leading-7">Event</div>
            </div>
            <div className="self-stretch h-40 flex flex-col justify-start items-start gap-3.5">
                <div className="self-stretch h-7 relative">
                    <div className="w-40 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Conference Schedule</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-32 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Venue Information</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-24 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">Past Events</div>
                    </div>
                </div>
                <div className="self-stretch h-7 relative">
                    <div className="w-10 h-5 left-0 top-[5.35px] absolute inline-flex justify-start items-start">
                        <div className="justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">FAQs</div>
                    </div>
                </div>
            </div>
        </div>
        <div className="self-stretch self-stretch inline-flex flex-col justify-start items-start gap-5">
            <div className="self-stretch h-7 relative">
                <div className="left-0 top-[-1.19px] absolute justify-start text-stone-800 text-xl font-medium font-['Inter'] leading-7">Connect</div>
            </div>
            <div className="self-stretch h-12 inline-flex justify-start items-start gap-5">
                <div className="w-12 h-12 bg-stone-800 rounded-full flex justify-center items-center">
                    <div className="w-6 h-6 relative overflow-hidden">
                        <div className="w-5 h-5 left-[1.98px] top-[1.98px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                        <div className="w-2 h-2 left-[7.97px] top-[7.89px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                        <div className="w-[0.01px] h-0 left-[17.35px] top-[6.44px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                    </div>
                </div>
                <div className="w-12 h-12 bg-stone-800 rounded-full flex justify-center items-center">
                    <div className="w-6 h-6 relative overflow-hidden">
                        <div className="w-5 h-4 left-[1.98px] top-[3.96px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                    </div>
                </div>
                <div className="w-12 h-12 bg-stone-800 rounded-full flex justify-center items-center">
                    <div className="w-6 h-6 relative overflow-hidden">
                        <div className="w-3 h-3 left-[9.91px] top-[7.93px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                        <div className="w-1 h-3 left-[1.98px] top-[8.92px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                        <div className="w-1 h-1 left-[1.98px] top-[1.98px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                    </div>
                </div>
                <div className="w-12 h-12 bg-stone-800 rounded-full flex justify-center items-center">
                    <div className="w-6 h-6 relative overflow-hidden">
                        <div className="w-5 h-3.5 left-[1.96px] top-[4.89px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                        <div className="w-[4.96px] h-1.5 left-[9.91px] top-[8.92px] absolute outline outline-2 outline-offset-[-0.99px] outline-gray-200" />
                    </div>
                </div>
            </div>
            <div className="self-stretch h-6 relative">
                <div className="w-5 h-5 left-0 top-[2.97px] absolute overflow-hidden">
                    <div className="w-4 h-[4.76px] left-[1.59px] top-[5.55px] absolute outline outline-[1.59px] outline-offset-[-0.79px] outline-stone-800" />
                    <div className="w-4 h-3 left-[1.59px] top-[3.17px] absolute outline outline-[1.59px] outline-offset-[-0.79px] outline-stone-800" />
                </div>
                <div className="left-[28.55px] top-0 absolute justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">info@tedx.com</div>
                </div>
            </div>
    </div>
    <div className="self-stretch h-[1.19px] relative border-t-[1.19px] border-stone-800/20" />
    <div className="self-stretch h-6 inline-flex justify-between items-center">
        <div className="w-[556.38px] h-6 relative">
            <div className="left-0 top-0 absolute justify-start text-stone-800 text-base font-normal font-['Manrope'] leading-6">© 2026 TEDx. This independent TEDx event is operated under license from TED.</div>
        </div>
    </div>
</div>
    <div className="w-full h-96 left-0 top-[7890px] absolute bg-white overflow-hidden">
    ...
    <div className="w-[925px] h-[469.99px] left-[63px] top-[206px] absolute">
        ...
        <div className="left-0 top-[250px] absolute inline-flex justify-start items-center gap-10 z-10 relative">
            <div className="w-48 h-20 relative bg-black/80 rounded shadow-[-5px_5px_5px_0px_rgba(0,0,0,0.10)] shadow-[inset_-2px_4px_7px_0px_rgba(0,0,0,0.05)] overflow-hidden">
                <div className="left-[29px] top-[21px] absolute text-center justify-start text-white text-2xl font-medium font-['Manrope']">Get Tickets</div>
            </div>
            <div className="w-48 h-20 relative bg-gray-200/80 rounded shadow-[-5px_5px_5px_0px_rgba(0,0,0,0.10)] shadow-[inset_-2px_4px_7px_0px_rgba(0,0,0,0.05)] overflow-hidden">
                <div className="left-[30px] top-[21px] absolute text-center justify-start text-black text-2xl font-medium font-['Manrope']">Learn More</div>
            </div>
        </div>
    </div>
    <div className="w-[calc(100%-28px)] h-[6685px] px-4 left-[14px] top-[1063px] absolute inline-flex flex-col justify-start items-center gap-28 overflow-hidden">
