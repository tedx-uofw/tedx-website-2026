...
import heroImage from '/landing/imprinted 1.svg'
import fingerprintImage from '/landing/full fingerprint 3.png'
import x2 from '/landing/x 2.png'
import venue from '/landing/venue.jpg'
import location from '/landing/location.svg'
import caraHeadshot from '/landing/Cara.png'
import melissaHeadshot from '/landing/Melissa.png'
import michaelHeadshot from '/landing/Michael.png'
import vitaHeadshot from '/landing/Vita.png'
import annHeadshot from '/landing/Ann.png'
import nanditaHeadshot from '/landing/Nandita.png'
