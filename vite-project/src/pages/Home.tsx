          ...
          <div className="w-full relative bg-linear-to-b from-white to-[#F7F9FB] overflow-hidden">
              ...
              <div className="relative z-10 w-full px-[63px] py-6 border-t border-black/10 max-md:px-5 max-md:py-4">
                  <div className="flex flex-col md:flex-row md:justify-between gap-3 md:gap-0 text-black text-base md:text-xl font-['Manrope']">
                      ...
                      <div className="flex items-baseline gap-2">
                          <a href="/#venue" className="font-medium">Kane Hall↗</a>
                          {/*<a*/}
                      ...
                      <div className="w-full flex flex-col lg:flex-row gap-6 items-stretch">
                          <div className="flex-1 flex flex-col justify-start gap-8">
                              <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex flex-col justify-start gap-4">
                                      <div className="text-gray-900 text-2xl md:text-3xl font-bold font-['Manrope'] leading-[36px] md:leading-[42px]">Kane Hall</div>
                                      <div className="flex flex-col gap-3">
                                          <div className="text-gray-600 text-base font-normal font-['Manrope'] leading-7">4069 Spokane Ln NE</div>
                                          <div className="text-gray-600 text-base font-normal font-['Manrope'] leading-7">Seattle, Washington 98105</div>
                          ...
                          <div className="flex-1 relative bg-white/0 rounded-[24px] shadow-[0px_32px_64px_-18px_rgba(0,0,0,0.25)] overflow-hidden h-[260px] md:h-[320px] lg:h-[520px]">
                              ...
                              <div className="absolute bottom-4 right-4 px-6 py-3 bg-black rounded-[12px] shadow-lg hover:bg-red-700 transition-colors duration-300 ease-out flex justify-center items-center gap-2.5 md:bottom-6 md:right-6 md:px-10 md:py-4">
                                  <a href="https://maps.google.com/?q=4069+Spokane+Ln+NE,+Seattle,+WA+98105" target="_blank" className="text-center text-white text-base md:text-xl font-normal font-['Manrope'] leading-6 md:leading-7">View on Map</a>
                              </div>
                          </div>
                      </div>
                  </div>
