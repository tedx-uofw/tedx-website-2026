...
const SponsorCard = ({ name, description }: SponsorProps) => (
  <div className="flex flex-col md:flex-row gap-12 py-16 border-t border-neutral-200">
    ...
    <div className="flex flex-col justify-start">
      <h3 className="text-4xl font-medium text-neutral-900 mb-6">{name}</h3>
    ...
    <div className="min-h-screen bg-white font-sans selection:bg-red-100 overflow-x-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-24">
        ...
        <header className="pt-40 pb-32">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-neutral-900 tracking-tight leading-tight max-w-3xl">
            Thank you for supporting <span className="font-sans font-bold">TEDx</span>UofW
          </h1>
        </header>
        ...
        {tiers.map((tier) => (
          <section key={tier.title} className="pb-20">
            <h2 className="text-6xl md:text-7xl font-bold text-neutral-900 mb-20 tracking-tighter">
              {tier.title}
            </h2>
